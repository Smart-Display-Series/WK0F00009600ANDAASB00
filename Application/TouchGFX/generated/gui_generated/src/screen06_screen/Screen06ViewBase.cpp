...
Screen06ViewBase::Screen06ViewBase()
{
    ...
    textArea2.setPosition(132, 0, 31, 80);
    textArea2.setColor(touchgfx::Color::getColorFrom24BitRGB(0, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setRotation(touchgfx::TEXT_ROTATE_270);
    Unicode::snprintf(textArea2Buffer, TEXTAREA2_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID35).getText());
...
void Screen06ViewBase::setupScreen()
{
