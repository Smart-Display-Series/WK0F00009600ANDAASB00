...
Screen07ViewBase::Screen07ViewBase()
{
    ...
    Unicode::snprintf(textArea2Buffer, TEXTAREA2_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID37).getText());
...
void Screen07ViewBase::setupScreen()
{
