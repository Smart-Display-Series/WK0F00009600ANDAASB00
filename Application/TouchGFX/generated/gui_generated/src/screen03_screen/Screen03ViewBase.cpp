...
Screen03ViewBase::Screen03ViewBase()
{
    ...
    Unicode::snprintf(textArea2Buffer, TEXTAREA2_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID29).getText());
...
void Screen03ViewBase::setupScreen()
{
