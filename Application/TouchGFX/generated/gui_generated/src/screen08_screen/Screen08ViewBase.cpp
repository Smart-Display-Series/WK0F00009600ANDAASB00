...
Screen08ViewBase::Screen08ViewBase()
{
    ...
    Unicode::snprintf(textArea2Buffer, TEXTAREA2_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID39).getText());
...
void Screen08ViewBase::setupScreen()
{
